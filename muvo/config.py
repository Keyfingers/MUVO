...
# 异常检测配置
_C.MODEL.ANOMALY_DETECTION = CN()
_C.MODEL.ANOMALY_DETECTION.ENABLED = False
_C.MODEL.ANOMALY_DETECTION.FREEZE_BACKBONE = True
_C.MODEL.ANOMALY_DETECTION.HEAD_TYPE = '3dcnn'
_C.MODEL.ANOMALY_DETECTION.OUTPUT_DIM = 1
_C.MODEL.ANOMALY_DETECTION.HIDDEN_DIM = 128
_C.MODEL.ANOMALY_DETECTION.NUM_HEADS = 8
_C.MODEL.ANOMALY_DETECTION.DROPOUT = 0.1

_C.MODEL.ANOMALY_DETECTION.POSITIONAL_ENCODING = CN()
_C.MODEL.ANOMALY_DETECTION.POSITIONAL_ENCODING.ENABLED = True
_C.MODEL.ANOMALY_DETECTION.POSITIONAL_ENCODING.TYPE = 'sincos'
_C.MODEL.ANOMALY_DETECTION.POSITIONAL_ENCODING.MAX_LEN = 10000

_C.MODEL.ANOMALY_DETECTION.FEATURE_ALIGNMENT = CN()
_C.MODEL.ANOMALY_DETECTION.FEATURE_ALIGNMENT.METHOD = 'bilinear'
_C.MODEL.ANOMALY_DETECTION.FEATURE_ALIGNMENT.USE_ALIGNMENT_NETWORK = True

_C.MODEL.ANOMALY_DETECTION.ABLATION_STUDY = CN()
_C.MODEL.ANOMALY_DETECTION.ABLATION_STUDY.ENABLED = False
_C.MODEL.ANOMALY_DETECTION.ABLATION_STUDY.EXPERIMENTS = ['no_pe', 'sincos_pe', 'learned_pe', 'hybrid_pe']
